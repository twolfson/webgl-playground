...
Definitely starting to idenitfy patterns more easily now
...
//     pct = sqrt(tC.x*tC.x+tC.y*tC.y);
    ...
    pct = step(0.1 + 0.1*abs(sin(u_time)), pct) - step(0.2, pct);
    vec3 color = vec3(atan(pct));
